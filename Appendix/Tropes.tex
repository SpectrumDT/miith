...
\begin{description}
  ...
  \item[Godzilla Threshold:] 
    Crossing this threshold prompts \Ishnaruchaefir to cause the Shrouding.
  ...
  \item[Shoot the Dog] 
  \item[Shoot the Hostage:] Maybe \hs{Shereid} should die this way\prikker
