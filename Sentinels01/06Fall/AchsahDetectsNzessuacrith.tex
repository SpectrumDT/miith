\bookchapter{\Achsah Detects \Nzessuacrith}
...
\Achsah, who has long \maybehr{Achsah suspects that Malcur is a decoy}{suspected that \Malcur was a decoy}, is the first to believe the \Forclin{} ruse. 

This whole chapter should run \emph{alongside} \Takestsha's battles against Curwen, Ilcas and Carzain. 
Remember that \Achsah already called for reinforcements to be sent to \Forclin back when Curwen convinced her that the Sentinels were after the Ghost Tower. 
Now she just has to alert them. 
She immediately goes to \Nyx with her companions, summons the \umbrae she needs and returns to \Forclin.
Fortunately she is right by the Ghost Tower, so she can just waltz into \Nyx and back. 
...
\Takestsha was badly shocked when \maybehr{Eresh-Kali magic backfires}{Curwen's counterspell struck} and caused her \quo{\EreshKali} master-spell to backfire. 
She had to suddenly use a lot of powerful magic just to keep alive. 
(Her \human body is much weaker than her \draconian body, and \maybehr{Ilcas injures Takestsha}{she was wounded by Telcastora Ilcas}.) 
...
Do not mention \Nzessuacrith's name, but do mention that she is kin to \Ishnaruchaefir and \Secherdamon. 
...
\Achsah{} needs help. 
An average \dragon is \maybehr{Dragons vs Resphain in power}{a terrible opponent}, even \maybehr{Umbra power}{if you have \umbrae} on your side.
...
She contacts her fellow \resphain who are working on the \maybehr{Malcur venture}{\Malcur venture} and requisitions reinforcements. 

The other \resphain are not happy about that, because they would like to keep some in reserve for \Ishnaruchaefir.
But Achsah pleads her case, and \Teshrial agrees with her (because he \maybehr{Teshrial fears to break agreement with Ishnaruchaefir}{fears to break \Ishnaruchaefir's agreement}).
(This happens before \Teshrial's duel has started.)

So a dozen \resphain hurry to \Forclin to fight off \Nzessuacrith. 
This includes the \resphain{} whom \Teshrial{} \maybehr{Teshrial leaves Bezed in charge}{left in charge of \Malcur}. 
...
\maybehr{Psyrex kills Paerzim}{That ends badly}. 
...
She is old enough to remember the days in \Merkyrah{} when \maybehr{Merkyrans fear Umbrae}{the \resphain{} lived in fear of the \umbra}. 
She remembers the terror and awe she felt when \maybehr{Rebels awestruck by tame Umbrae}{she first saw the rebel leaders riding \umbrae}, back when she was just a rank-and-file rebel acolyte. 
