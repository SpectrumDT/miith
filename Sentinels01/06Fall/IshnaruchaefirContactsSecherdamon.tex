...
\ta{This is terrible news. 
  ...
  I must find a way to deal with them\prikker}

\Ishnaruchaefir:
\ishna{I will deal with them.}

\Psyrex:
\ta{You will what?}

\Ishnaruchaefir:
\ishna{I have remained aloof from the \feud for too long.}
...
\tele{Listen\prikker we may need to adjust our plans.}

\tho{I do not like the sound of this.}
\ta{Adjust? What do you mean?}

\Psyrex:
\tele{I was recently contacted\prikker by the Exile.}
