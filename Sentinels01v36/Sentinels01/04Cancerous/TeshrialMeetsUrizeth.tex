...
\ta{%
  ...
  Indeed, when the \SitraAchras first set foot on \Miith, long before the \resphain... then the spawn of \Sethicus were there to challenge them.}
...
\ta{This is... fascinating. 
  A recurring Nadir... yes, that makes perfect sense.
  The Exile is a major \vertex, after all.
  Strange, though, that no one has mapped it before, if it is true...}
