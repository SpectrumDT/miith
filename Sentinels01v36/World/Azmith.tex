...
\target{Imrath}
\index{\Imrath}
The kingdom to which \hs{Silqua} and \hs{Cordos Vaimon} belonged. 
...
\subsection{History}
\Tepharae (together with \hr{Telcra}{\ClanTelcra}) \hr{Tepharae suceeds Ortaica}{rose to prominence after the fall of \Ortaica}.
...
\citeauthorbook[p.24]{RobertEHoward:TheShadowKingdom}{Robert E. Howard}{%
  ...
  Clang! clang! clang! sounded the silver hoofs on teh broad, moon-flooded streets, but otherwise there was no sound.
  ...
  \ta{You are young,} said teh palaces and the temples and the shrines, 
  \ta{but we are old.
    The world was awild with youth when we were reared.
    You and your tribe shall pass, but we are invincible, indestructible.
    We towered above a strange world, ere Arlantis and Lemuria rose from the sea; we still shall reign when teh green waters sigh for many a restless fathom above the spires of Lemuria and the hills of Atlantis and when the isles of the Western Men are the mountains of a strange land.
...
When describing the garden, remember to see the section about the \hr{Wylde}{\wylde}, and especially the one on \hr{Travelling through the Wylde}{travelling through the \wylde}. 
...
\Yormis was founded some time after the \hr{Hundred Scourges}{\HundredScourges} as an \Ortaican city. 
...
\citeauthorbook[On the Origin of the World, p.178]{%
  ...
  When she has created the first work, she will take off her wise flame of sinsight.
  ...
  When he destroys them, he will turn against himself and detroy himself until he ceases to be. 
  ...
  The light will cover the darkness, and ti will wipe it out.
  It will become like one which had not come into being.
  And the work which the darkness followed will be dissolved.
  And the deficienty will be plucked out at its root and thrown down to the darkness.
  ...
  For it is necessary that every one neter the place from whence he came.
...
In Rissitic mythology this schism became represented as a myth of a battle between the gods. 
...
The name is derived from a longer name meaning \quo{the Order of the Rusty-Red \Corgorah}. 

They receive \hr{Rissitic new names}{new names} when they become \Ashenoch. 
...
The process is similar to, and derived from, the \hr{Shaeeroth ritual}{process that turns a \dragon} into a \hr{Shaeeroth}{\shaeeroth}. 
...
Another source of these stories, buried deep down in \human{} racial memory, is the vague recollection of \hr{Aryothim kill QJ}{the far older wars between the \aryothim{} and the \quiljaaran}. 
