...
\target{Phaetonian age}
Before the \ophidians, the \hr{Nibir} dominated \Miith. 
They were served by a lesser race called the \hr{Phaetonians}{Phaetonians}. 
...
\subsubsection{\Ophidians created by \voyagers?}
\target{Voyagers create Ophidians}
...
\hr{Myths about Voyager appearance}{Some wrongly have the \voyagers look like snakes} (in an attempt to explain why snakes are sacred).
...
The fledging \ophidian civilization waged bitter wars against the Phaetonians.
...
\subsection{Wars}
Before the time of the \dragons, the \caisith waged terrible wars amongst themselves. 
They were techno-barbarians led by warlord kings and necromancers. 
In the absence of fossil fuels they could not build war machines like ours, so instead they used sorcery to breed living weapons. 
They created abominations like in the game \emph{Cave Evil}. 
...
\target{Zoarch dress}
The Zoarchs traditionally wore short buttoned coats similar to Chinese tangzhuang, always with a metallic edge (often black and silver). 




\subsubsection{Nom and Golem}
The kingdoms of \hr{Nom}{\Nom} and Golem emulated Oshur culture and could be considered the heirs and successors of Oshurae. 

The nobility of Nom and Golem emulated the \hr{Zoarch dress}{traditional dress of the Zoarchs}. 
...
\Sethicus and \Tiamat were looking for \hr{Phaetonian writings}{Phaetonian writings}, hoping to glean the secrets of their sorcery and technology. 
