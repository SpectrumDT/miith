...
At the time \Nom was one of the last bastions of the \shugul on \Miith (after the \ophidians \hr{Ophidians drive out Shugul}{had driven them out}). 
...
He then proceeded to build the gigantic fortress-city of \hr{Baltherium}{\Baltherium}, built upon ancient \shugul ruins and drawing upon the \dweomers of captive \moongods. 
...
\subsection[Tiamat as a Dark Messiah]{\Tiamat{} as a Dark Messiah}
...
She read too much of the \hr{Umaja}{Umaja Tablets}.
It drove her mad. 
...
This god was one of the reasons why the \dragons had to go into \hs{Durance}.
...
Later \hr{Ark uses Tiamat's Heart}{her heart would be used} to create the \hs{Ark}+.
...
% 
% Or\prikker perhaps \Tiamat did not die in the \firstbanewar.
