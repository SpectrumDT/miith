...
%I shuddered to think of those crypts, rumoured to predate \Yormis by millennia and to hold a whole subterranean city built by pre-\scathaese hands. 
...
\ta{%
  In here is where you will face your initiation, Mephilex,} said my father.
\ta{% 
...
\ta{This is the heart of \Yormis,} said my father. 
...
% 
% We walked for a while in silence before I dared speak again. 
% 
% \ta{Father, those things I saw out there in the shadows\prikker are they of the Master\prikker?}
% 
% \ta{They are his slaves.
%   Half \scathae, half other things. 
%   You remember I told you that the elder race could shape life itself.}
% 
...
% Fear and wonder coursed through me. 
...
\ta{Before you meet the Master, I will tell you about one more thing,} said my father.
...
%   Dirt and dust. 
  You also know that the Vaimon religion is false.
...
\ta{So\prikker father\prikker are you saying that\prikker this mosca flesh\prikker?}
...
% \ta{Father\prikker what are you telling me?}
% 
% \ta{A \scatha grows by absorbing the vitality of others like him. 
%   Those who are pure.} 
% 
...
% In my state and the dim torchlight its visage seemeed demonic and mocking, but it was better than the Jaslars. 
...
\ta{Merciful \Nasshikerr,} I intoned in the secret \Draconic tongue, 
...
No. 
My father had said that the Jaslars also served the Master, and Thul had said \quo{Clan Suthis's hidden god}.
Was this some other entity?
What was it my father had said? 
That there was another, a hidden one.

\tho{Who or what is \Ubloth?}
...
The book showed a section with the heading \quo{\emph{Formula for Distilling Elixir of Purity}}.
The word \quo{purity} made me shiver as it brought to mind my father's terrible words. 
...
\ta{Yuck!
  This tunnel is full of goo, and it stinks!}
...
\ta{Get her!
  ...
  The slime is not going to attack us. 
...
\ta{This time you are going to die. 
  Cowering in the filth like the weakling you are.}
...
\gitem{\Ortaica}
\target{Ortaica}
A great \hr{Scatha}{\scatha}-dominated realm that flourished after the \maybehr{Hundred Scourges}{\HundredScourges}. 
