...
\target{Myths about Voyager appearance}
...
\subsubsection{Created \ophidians and \nephilim}
Some myths say that the \voyagers \hr{Voyagers create Ophidians}{created the \ophidians}, and \hr{Voyagers create Nephilim}{maybe also the \nephilim}.
...
\target{Nibir}
\index{Nibir}%
Before the \ophidians, the Nibir \hr{Phaetonian age}{dominated \Miith}. 
...
\target{Voyagers create Nephilim}
Some myths say that the \nephilim were created by the \voyagers (\hr{Voyagers create Ophidians}{just like the \ophidians before them}). 
...
Some physical Phaetonian writings did exist. 
