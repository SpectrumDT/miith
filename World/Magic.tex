...
Vaimons, for example, developed \hr{Vaimon stigmata}. 
...
A circle of mages \hr{Circles are Matrices}{is a small, temporary \nexus} and obeys (or should obey) the rules for \nexuses. 
...
\hs{Imetric magic} was very much inspired by the \caisith and \quiljaaran traditions.
...
Supporters may also double as menial servants, bodyguards or even apprentice mages. 
...
\target{usurer}
\index{usurer}
A \quo{usurer} was a type of \daemon that could be summoned by sorcerers.
...
If the sorcerer failed to provide sacrifices in time to feed the usurer, the usurer would turn on him and drain his vital energy. 
...
As a rule of thumb, the amount of energy that the usurer requires in return is always roughly proportial to the amount of energy it has \quo{lent out}. 
...
Most humans dwelling in Ishar/Miith are anchored in a barren valley of great rocks. 
...
See also the section about \hs{Wyrms}.
...
For maximum effect, the \cardinalpoints must have the correct number and be correctly arranged (in accordance with \hs{occult geometry} and the \hr{Matrix formation}{formation of the \nexus}). 
...
A \hs{circle of mages} is {a small, temporary \nexus}. 
As such, it obeys (or should obey) the rules of \hr{Matrix formation}{\nexus formations}, \hs{occult geometry} and numerology. 
...
\begin{gloss}
  ...
  \gitemthe{Midnight Bat} 
    \target{Midnight Bat}
    \hr{Mystraacht Matrix}{\Mystraacht{} \nexus}. 
...
A Nadir is a \quo{low point} for a \nexus{}, constellation or \vertex. 
...
\begin{gloss}
  ...
  See the section on \hr{Caisith magic}{\caisith magic}.
