...
\section{Horror of the nature of the cosmos}
See also the section about \hr{The dark universe}{the dark, sinister universe}. 
...
\citeauthorbook[p.16]{VengerSatanis:CthulhuCult}{Venger Satanis}{Cthulhu Cult}{
  This entire illusion, our whole world, is a pale reflection of a hidden reality.
  Corpulent, rotting dreams stretch out farther than infinity and are guided by a foul devotion\ldots{}
  how can we accept a universe where entropy is the rule?
}
...
A more accurate term might perhaps be \quo{Incomplete Death}. 
...
\target{Horrors are False Death}
Many of the \hr{Horrors of the Void}{horrors of the void} were likewise manifestations of rot and decay, of False Death. 

\target{Voyagers are False Life}
...
No new \xss could ever be spawned\ldots{} unless \hr{Sethicus plan}{\Sethicus's plan} succeeded.

There were also beings called the Screaming Gods. 
...
\begin{prose}
  Sethicus:
  \ta{I have heard the weeping and wailing of the endless void.
    Thinkest thou that the nothingness itself cannot suffer?
    Thou knowest nothing.
    Thou hast not seen what I have seen; the visions of a universe whose every fibre was once alive but now lies dead, trapped in an eternal hell.}
\end{prose}

\citebandsong{BlindGuardian:ATITM}{Blind Guardian}{This Will Never End}{
  The vision's bleak and its colour's black.\\
  Oh, far beyond there is a starving, dying sun.
}

\citeauthorbook[p.21]{HPLovecraft:TheAncientTrack}{%
  \HPLovecraft%
}{%
  A Poe'et's Nightmare%
}{%
...
\citeauthorbook[p.27]{HPLovecraft:TheAncientTrack}{%
  \HPLovecraft%
}{%
  Nemesis%
}{%
...
\Sethicus feared his visions. 
They drove him half-mad. 

\citeauthorbook[p.28]{HPLovecraft:TheAncientTrack}{%
  \HPLovecraft%
}{%
  Nemesis%
}{%
...
\hr{Addiction to knowledge}{Enlightenment is addictive}. 
...
\target{Addiction to knowledge}
Knowledge and enlightenment could be highly addictive. 
\hr{Sethicus addicted to knowledge}{\Sethicus experienced this}. 

Like Machen p. 75. 

\citeauthorbook[pp.75--76]{ArthurMachen:TheInmostLight}{Arthur Machen}{The Inmost Light}{%
  What are commonly called the pleasures of life had never had any attractions for me...
  So long as I could gratify my desire of knowledge of a particular king, knowledge of which the very existence is a profound secret to most men, I was intensely happy, and I have often spent whole nights sitting in the darkness of my room, and thinking of the strange world on the brink of which I trod. 
  ...
  I had learnt enough of the paths I had begun to tread to know that they were beyond all expression difficult and dagerous, that to persevere meant in all probability the wreck of a life, and that they led to regions so terrible, that the mind of man shrinks appalled at the very thought. 
  ... 
  But suddenly... the old desire, the former longing, returned, and returned with a force that had been intensified ten times by its absence; and when the day dawned and I looked out of the window, and saw with haggard eyes the sunrise in the east, I knew that my doom had been pronounced; that as I had gone too far, so now I must go farther with unfaltering steps. 
  ... each night I had stolen a step nearer to that great abyss which I was to bridge over, the gulf between the world of consciousness and the world of matter.
  My experiments were many and complicated in their nature, and it was some months before I realized whither they all pointed, and when this was borne in upon me in a moment's time, I felt my face whiten and my heart still within me.
  But the power to draw back, the power to stand before the doors that had now opened wide before me and not to enter in, had long ago been absent; the way was closed, and I could only pass onward.
  My position was as utterly hopeless as that of the prisoner in an utter dungeon, whose only light is that of the dungeon above him; the doors were shut and escape was impossible. 
  ...
  In that work, from which even I doubted to escape with life, life itself must enter; from some human being there must be drawn that essence which men call the soul, and in its place (for in the scheme of the world there is no vacant chamger)\dash in its place would enter in what the lips can hardly utter, what the mind cannot conceive without a horror more awful than the horror of death itself.
}
...
\subsubsection{Corruption by knowledge}
\target{Corruption by knowledge}
Those who understand too much will be inexorably drawn towards changes in opinion that others often consider perverse and evil. 

The ignorant tend to believe in morality and in a benign fate, gods and/or afterlife. The learned realize that morality is a lie, life and consciousness but illusions, and the afterlife (when it exists) worse than oblivion. The learned often become drawn to new ambitions (for pleasure or for a newfound and \quo{higher} cause) which seem criminal to others. The unenlightened cannot comprehend \quo{higher} causes and see only evil. 

\target{Vril shokraan}
\index{\emph{vril shokraan}}%
\emph{Vril shokraan} is a \hr{Talaac}{Talaac} word for those whose minds, through knowledge and experience, have grown so alien and different as to be dangerously insane from the perspective of society. 
...
\target{Mysticism}
\index{mysticism}%
To avoid knowing too much \hr{Knowledge is horrible}{horrifying, maddening knowledge}, many mages turn to mysticism: 
...
That was why the \hr{Umaja}{Umaja Tablets} were dangerous. 
...
This was because \hr{Sethicus in the Threnody}{\Sethicus had become a new voice in the choir of the Threnody}.
...
\target{Umaja}
\index{\UmajaTablets}
The true living beings (the \hs{Greatest Race}) stored their knowledge in a comsic repository, woven into the very background fabric of the universe itself.
This was called the \UmajaTablets, although the \quo{tablets} were purely metaphorical.
...
Thus the \UmajaTablets were \quo{tainted} with madness. 
...
\target{Umaja supermind}
Umaja was originally the shared supermind of the Greatest Race. 
Their \nexus. 
\hs{Ramarxes} would use it as inspiration for his \hs{Concord}. 
...
When the \hr{Greatest Race} discovered the \hr{Knowledge is horrible}{terrifying truth}, the knowledge drove the universe itself mad (creating the \hr{Necrocosmos}). 

This connection between mind, body and space is why it is possible to see into a different layer of reality and suddenly move there. This connection is also the basis for all life and magic. 
